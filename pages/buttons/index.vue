        ...
        <div class="col-md-6">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                Social Buttons (By
                <a href="https://github.com/lipis/bootstrap-social">Lipis</a>)
              </h3>
            </div>
            <div class="box-body">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <p>
                ...
                <code>.btn</code> and add any available <code>.bg-*</code> class
              </p>
              ...
              <p>
                ...
                <button type="button" class="btn bg-navy margin">
                  .btn.bg-navy
                </button>
