        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-sm-4 col-md-2">
              ...
              <div class="color-palette-set">
                <div class="bg-aqua disabled color-palette">
                  <span>Disabled</span>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-md-2">
              ...
              <div class="color-palette-set">
                ...
                <div class="bg-purple-active color-palette">
                  <span>Active</span>
                </div>
              </div>
            </div>
            ...
            <div class="tab-content">
              <div id="tab_1" class="tab-pane active">
                ...
                <p>
                  ...
                  the custom wrapper
                  <code>.nav-tabs-custom</code> to achieve this style.
                </p>
        ...
        <div class="col-md-6">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              <li class="active">
                <a href="#tab_1-1" data-toggle="tab">Tab 1</a>
              </li>
              <li>
                <a href="#tab_2-2" data-toggle="tab">Tab 2</a>
              </li>
              <li>
                <a href="#tab_3-2" data-toggle="tab">Tab 3</a>
              </li>
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                  Dropdown
        ...
        <div class="col-md-6">
          <div class="box box-solid">
            ...
            <div class="box-body text-center">
              <p>
                By adding the class
                <code>.vertical</code> and <code>.progress-sm</code>,
                <code>.progress-xs</code> or <code>.progress-xxs</code> we
                achieve:
              </p>
