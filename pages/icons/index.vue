<template>
  <div>
    <breadcrumb
      ...
      :optionalDescription="'Control panel'"
      :level="'Home'"
        ...
        <div class="col-xs-12">
          <div>
            <b-tabs content-class="mt-3">
              <b-tab title="Font awesome" active>
                <section id="new">
              ...
              <b-tab title="Glyphicons">
                <ul class="bs-glyphicons">
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-paste</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-alert"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-alert</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-king</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-queen"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-queen</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-pawn"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-pawn</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-bishop"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-bishop</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-knight"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-knight</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-apple</span
                    >
                  </li>
                  <li>
                    <span class="glyphicon glyphicon-erase"></span>
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-erase</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-bitcoin</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-ruble</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-scale</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-grain</span
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="glyphicon-class"
                      >glyphicon glyphicon-console</span
                    >
                  </li>
                  <li>
